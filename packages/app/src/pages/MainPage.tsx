...
export const MainPage: React.FC<{}> = (props) => {
  ...
  const [proofGenerationMethod, setProofGenerationMethod] = useState<
    "local" | "remote"
  >("local");
  ...
  const handleGenerateProofRemotely = async () => {
    ...
    setProofGenerationMethod("remote");
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        setProofGenerationMethod("local");
